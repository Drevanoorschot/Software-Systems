...
/*
 * 7.2) the draw thread of the mandel is not locked, which means the menu
 * can be executed at the same time. When the mandel comes along it will
 * overwrite the menu.
 * 
 * 7.3) drawMandel() is locked so no other things can be executed when the
 * mandel is being drawn
 */
